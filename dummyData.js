export const initialPosts = [
  ...
  { id: 'b1', type: 'board', coordinate: { latitude: 37.475, longitude: 126.936 }, emoji: '🏪', title: '동네 마트 소식', description: '매일매일 할인 정보가 올라옵니다!', createdAt: Date.now(), boardPosts: [
    { id: 'bp1', emoji: '🥚', title: '오늘의 특가', content: '계란 한 판 4,000원!', createdAt: Date.now() - 100000, comments: [] },
    { id: 'bp1-2', emoji: '🍜', title: '[테스트] 라면 행사', content: '봉지라면 5+1 행사 중입니다.', createdAt: Date.now() - 90000, comments: [] },
    { id: 'bp1-3', emoji: '🍓', title: '[테스트] 과일 코너', content: '딸기/사과 시식 가능합니다.', createdAt: Date.now() - 80000, comments: [] },
    { id: 'bp1-4', emoji: '🏷️', title: '[테스트] 마감 임박', content: '유통기한 임박 상품 할인 중!', createdAt: Date.now() - 70000, comments: [] }
  ] },
  { id: 'b2', type: 'board', coordinate: { latitude: 37.465, longitude: 126.930 }, emoji: '☕', title: '카페 코딩', description: '조용하게 코딩하기 좋은 카페입니다. 오늘의 원두 라인업 공유해요.', createdAt: Date.now() - 86400000, boardPosts: [
    { id: 'bp2', emoji: '☕', title: '에티오피아 예가체프 입고', content: '산미 있는 커피 좋아하시는 분들 오세요!', createdAt: Date.now() - 50000, comments: [] },
    { id: 'bp2-2', emoji: '🔌', title: '[테스트] 콘센트 좌석', content: '창가쪽 콘센트 좌석 3자리 비었습니다.', createdAt: Date.now() - 40000, comments: [] }
  ] },
  { id: 'b3', type: 'board', coordinate: { latitude: 37.478, longitude: 126.940 }, emoji: '🏋️', title: '득근 헬스장', description: '오운완 인증하고 정보 공유하는 스테이션', createdAt: Date.now() - 172800000, boardPosts: [
    { id: 'bp3', emoji: '🦵', title: '오늘 하체 루틴', content: '스쿼트 100kg 달성했습니다.', createdAt: Date.now() - 200000, comments: [] },
    { id: 'bp3-2', emoji: '📣', title: '[테스트] PT 공지', content: '저녁 7시 그룹 PT 1자리 남음.', createdAt: Date.now() - 180000, comments: [] }
  ] },
  ...
  { id: 'b4', type: 'board', coordinate: { latitude: 37.470, longitude: 126.942 }, emoji: '📚', title: '동네 도서관', description: '새로 들어온 신간 도서와 독서 모임 정보를 나눕니다.', createdAt: Date.now() - 259200000, boardPosts: [
    { id: 'bp4', emoji: '📖', title: '이번 주 신간', content: '베스트셀러 소설 3권 입고되었습니다.', createdAt: Date.now() - 10000, comments: [] },
    { id: 'bp4-2', emoji: '🪑', title: '[테스트] 열람실 공지', content: '주말 운영시간 연장되었습니다.', createdAt: Date.now() - 9000, comments: [] }
  ] },
  ...
  { id: 'b5', type: 'board', coordinate: { latitude: 37.474, longitude: 126.933 }, emoji: '🐾', title: '댕댕이 산책 모임', description: '강아지 산책 친구 구하는 스테이션입니다.', createdAt: Date.now() - 50000000, boardPosts: [
    { id: 'bp5', emoji: '🐕', title: '오늘 저녁 산책', content: '보라매공원 쪽으로 같이 도실 분?', createdAt: Date.now() - 20000, comments: [] },
    { id: 'bp5-2', emoji: '🗺️', title: '[테스트] 산책 코스 추천', content: '도림천 코스가 강아지들 반응이 좋아요.', createdAt: Date.now() - 15000, comments: [] }
  ] },
